...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body>
        <p>
            ...
            and men of Belial, of those that went 
        ...
        <p>
            ...
            Then said David, Ye shall not do so, 
        ...
        <p>
            ...
            For who will hearken unto you in 
        ...
        <p class=boxdis>
            Note:
            I just love the generosity then king David showed in this verses.
            Later leaders in other cultures used this reward system(I think)
            aswell out of kindness or simply as a prevention to mutiny, desertion
            or looting civilian property. All in all, I can see why the Lord Father
            love this king so much. 
        </p>
    </body>
</html>